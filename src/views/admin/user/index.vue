  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <template v-if="showFilter">
        ...
        <el-button class="filter-item" v-if="userManager_btn_add" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">添加</el-button>
        <el-button class="filter-item" v-if="userManager_btn_add" style="margin-left: 10px;" @click="handleWechatUser" type="primary" icon="el-icon-edit">同步微信人员</el-button>
      </template>
      <template  v-if="!showFilter">
          ...
          <template slot-scope="scope">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="userManager_btn_edit" @click.native="handleWechatUserByUserId(scope.row)">获取微信信息</el-dropdown-item>
                <el-dropdown-item v-if="userManager_btn_edit" @click.native="handleResetPassword(scope.row)">重置密码</el-dropdown-item>
...
<script>
  import { page, saveObj, getObj, delObj, baseInfo, deptList, wechatUser, updateStatus, resetPassword, wechatUserByUserId } from 'api/admin/user/index';
